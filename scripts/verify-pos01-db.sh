...
psql "${DB_URL}" -v ON_ERROR_STOP=1 -f supabase/migrations/20260813023000_pos01_lock_hard_validation.sql >/tmp/pos01_migration_batch5.log
...
psql "${DB_URL}" -v ON_ERROR_STOP=1 -f scripts/sql/verify_pos01_write_rpcs_v3.sql | tee /tmp/pos01_verify_batch5.log
