...
截至 2026-08-18，Phase 0–2 和 Email Marketing 已上线。按当前最小申报范围，剩余产品开发与证据工作约为 **7–12 个工程师周**：Payroll 3–5 周、Dashboard/Reports/Export 2–3 周、PDPA 产品控制与申请证据 2–4 周。该估算包含 Migration、权限和针对性测试，不包含外部 VA/PT、组织认证及 IMDA 审核等待；每个任务完成后应重估。

主要不确定因素：

- Payroll 官方规则变更和边界案例验证
- 第三方服务的测试和正式环境审批
