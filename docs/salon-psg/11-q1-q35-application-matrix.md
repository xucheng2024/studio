...
| Q4 Appointment Scheduling | ❌ 不满足 | Yes | 完成 `APT-01` 至 `APT-03`：一对一 Salon Appointment、员工时间、房间/床位/设备、跨门店冲突、状态、取消/改期和原子占用。现有课程 Session 不作为证据。 |
| Q5–Q6 Online Booking | 🟡 模块存在但不完整 | Yes | 完成 `APT-04`、`APT-05`：安全登录后的实时档期、客户自助预约/取消/改期、Package Credits/资格或订金/全额付款、Terms 展示及版本化接受证据、确认/提醒/变更通知。 |
| Q7 Customer Management | 🟡 部分满足 | Yes | 完成 `FND-02`、`CRM-01`、`CRM-02`：Studio-scoped Customer、偏好、过敏、健康/禁忌、服务员工、疗程历史、Follow-up、Consent 和敏感权限。 |
...
| Q11–Q12 Package | 🟡 模块存在但不完整 | 完成后 Yes | 完成 `PKG-01`、`PKG-02`：价格、次数、促销/折扣、有效期、适用服务/门店、余额 Ledger、人工调整申请、maker-checker 审批和完整审计。未完成前不能填 Yes。 |
...
| Q15 POS | 🟡 部分满足 | Yes | 完成 `POS-01` 至 `POS-04`：客户、多服务/商品购物车、员工、折扣、Cash/HitPay、收据、退款/作废、库存联动、门店归属和日结。申报为 in-house POS。 |
| Q16 SMS / E-Marketing | ❌ 尚未开发 | Yes（路径已确认） | 已确认本题是 OR。本次只完成 `MKT-01`、`MKT-02`：VIP/常客/长期未到店、Email Builder、图片/CTA、Email 立即或预约发送、成功率、点击率和退订。SMS、WhatsApp 不做。 |
...
- Q7：`src/app/(app)/dashboard/clients/[clientId]/page.tsx` 当前重点是通用客户资料、Notes 和 Package Ledger，没有结构化健康/疗程模型。
