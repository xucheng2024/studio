      ...
      <details className={`chevron ${ui.card}`}>
        ...
        <form action={createMemberZoneSeries} className="mt-4 grid gap-4 sm:grid-cols-2">
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <select name="access_type" defaultValue="members_only" className={ui.select}>
          ...
          <label className="flex flex-col gap-1.5">
            <span className={ui.label}>Price (if paid)</span>
          ...
          <div className="sm:col-span-2">
            <SeriesAccessPreview initialAccessType="members_only" initialCurrency="SGD" initialPrice={0} />
          </div>
          <div className="sm:col-span-2">
            <CoverVideoFields
              studioId={studio.id}
          ...
          <div key={series.id} className={ui.card}>
            ...
            <details className="chevron">
              ...
              <div className="mt-3 grid gap-3 border-t border-stone-100 pt-3 dark:border-stone-800 sm:grid-cols-2">
                ...
                <label className="flex flex-col gap-1.5">
                  <span className={ui.label}>Access</span>
                  <select name="access_type" defaultValue={series.access_type ?? "members_only"} className={ui.select}>
                    <option value="members_only">Members only</option>
                    <option value="paid">Paid</option>
                    <option value="free">Free</option>
                  </select>
                      ...
                      <div className="mt-3 grid gap-2 border-t border-stone-100 pt-3 dark:border-stone-800 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                          <LessonAccessPreview
                            ...
                            initialOverride={
                              (String(lesson.access_override ?? "inherit").toLowerCase() as "inherit" | "free" | "paid" | "members_only")
                            }
