  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h1 className={ui.h1}>Runbook · POS-04 作废/退款排障 SOP</h1>
      ...
      <section className={ui.card}>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-stone-700 dark:text-stone-300">
          ...
          <li>客户已收款后需要原路退款（Refund）。</li>
          <li>看板出现 <span className={ui.code}>void_pos_sale_failed</span> 或 <span className={ui.code}>refund_pos_sale_failed</span>。</li>
        </ul>
      </section>
      ...
      <section className={ui.card}>
        ...
        <ol className="mt-2 list-decimal space-y-2 pl-5 text-sm text-stone-700 dark:text-stone-300">
          <li>先确认销售单当前状态：<span className={ui.code}>draft/pending_payment</span> 才能 Void；<span className={ui.code}>paid</span> 只能走 Refund。</li>
