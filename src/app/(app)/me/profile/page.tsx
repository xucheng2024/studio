          ...
          <div className="mt-2 border-t border-stone-200 pt-4 dark:border-stone-700">
            ...
            <div className="mt-3 grid gap-3">
              <label className="grid gap-1.5">
                ...
                <input name="shipping_name" className={ui.input} defaultValue={profile?.shipping_name ?? ""} />
              </label>
              <label className="grid gap-1.5">
              ...
              <label className="grid gap-1.5">
                ...
                <input name="shipping_address_line1" className={ui.input} defaultValue={profile?.shipping_address_line1 ?? ""} />
              </label>
              <label className="grid gap-1.5">
                <span className={ui.label}>Address line 2</span>
                <input name="shipping_address_line2" className={ui.input} defaultValue={profile?.shipping_address_line2 ?? ""} />
              </label>
              <div className="grid gap-3 sm:grid-cols-2">
                <label className="grid gap-1.5">
                  <span className={ui.label}>City</span>
                  <input name="shipping_city" className={ui.input} defaultValue={profile?.shipping_city ?? ""} />
                </label>
                <label className="grid gap-1.5">
                  <span className={ui.label}>Postal code</span>
                  <input name="shipping_postal_code" className={ui.input} defaultValue={profile?.shipping_postal_code ?? ""} />
                </label>
              </div>
              <label className="grid gap-1.5">
                <span className={ui.label}>Country</span>
                <input name="shipping_country" className={ui.input} defaultValue={profile?.shipping_country ?? "SG"} />
              </label>
            </div>
          </div>
          <div>
