          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 text-lg leading-relaxed text-stone-600 dark:text-stone-300">
                Hosted booking pages, automatic payment reconciliation, and a real-time front desk dashboard — built for <span className="font-medium text-stone-900 dark:text-stone-100">Health and Wellness Studios</span>.
              </p>
